...
def test_day_03_2015():
    ...
    if environment == "development":
        expected_result_one = int(os.getenv("SOLUTION_01_DAY_03_2015"))
        result_one = solve_day_03_2015_one(file_path)
        assert expected_result_one == result_one
        expected_result_two = int(os.getenv("SOLUTION_02_DAY_03_2015"))
        result_two = solve_day_03_2015_two(file_path)
